...
public class NoteEditor extends Activity {
	// XXX Add message for the getStringExtra
	//public final static String EXTRA_MESSAGE = "com.example.android.notepad.NoteEditor.MESSAGE";

	// for the notification manager
	final int NOTIFY_ME_ID = 1337;
	NotificationManager notificationManager;

	/*
	 * public void createNotification(View view) { // XXX Notification; notify()
	 * can throw IAE // prepare intent which is triggered if the // notification
	 * is selected Intent intent = new Intent(this, NotificationReceiver.class);
	 * // use System.currentTimeMillis() to have a unique ID for the pending
	 * intent PendingIntent pIntent = PendingIntent.getActivity(this, (int)
	 * System.currentTimeMillis(), intent, 0);
	 * 
	 * // build notification // the addAction re-use the same intent to keep the
	 * example short
	 * 
	 * @SuppressWarnings("deprecation") Notification n = new
	 * Notification(R.drawable.note, "Hello", System.currentTimeMillis());
	 * 
	...
	private void getNotif(String notificationTitle, String notificationMessage) {
		// intent
		Intent notificationIntent = new Intent(this, NotificationReceiver.class);
		PendingIntent pendingIntent = PendingIntent.getActivity(this, 0, notificationIntent, 0);
		
		// notification builder
		Notification.Builder builder = new Notification.Builder(NoteEditor.this);
		...
		// notification.setLatestEventInfo(NoteEditor.this, notificationTitle, notificationMessage, pendingIntent);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		/*
		 Button b1=(Button)findViewById(R.drawable.button);
	      ...
	      b1.setOnClickListener(new View.OnClickListener() {
	         ...
	         public void onClick(View v) {
	            ...
	            //Notification notify = new Notification(R.drawable.note, "New Message", System.currentTimeMillis());
	...
	private final void deleteNote() {
		if (mCursor != null) {
			...
			// XXX It can throw an IndexOutOfBounds; when there is an array in
			// the arguments -> user input
			char[] chAr = { ' ' };
			mText.setText(chAr, 0, 1);
		}
	}
}
